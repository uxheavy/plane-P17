...
export const getCoreAuthenticationModesMap: (
  ...
  "unique-codes": {
    ...
    name: "Unique codes",
    description:
      "Log in or sign up for Company Runner using codes sent via email. You need to have set up SMTP to use this method.",
  ...
  github: {
    key: "github",
    name: "GitHub",
    description: "Allow members to log in or sign up for Company Runner with their GitHub accounts.",
    icon: (
      <img
  ...
  gitlab: {
    key: "gitlab",
    name: "GitLab",
    description: "Allow members to log in or sign up for Company Runner with their GitLab accounts.",
  ...
  gitea: {
    key: "gitea",
    name: "Gitea",
    description: "Allow members to log in or sign up for Company Runner with their Gitea accounts.",
