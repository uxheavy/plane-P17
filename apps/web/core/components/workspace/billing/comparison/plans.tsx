...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          "Track progress in cycles, modules, and overviews\nthroughout Company Runner without switching to dashboards\nor Analytics.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      // },
      {
        title: "PQL",
        description:
          "Write Company Runner Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.",
        cloud: {
          free: false,
          one: false,
          pro: true,
    ...
    features: [
      {
        title: "GitHub",
        description:
          "Sync Company Runner work items and states to GitHub work items and\nstates. Update GitHub automatically with activity\nfrom Company Runner and vice-versa.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        title: "Slack",
        description:
          "Get Company Runner activity in Slack and use / commands in\nSlack to make changes in Company Runner.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: "Create Company Runner work items from Zendesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: "Create Company Runner work items from Freshdesk tickets.",
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Choose other domains that can authenticate into\nyour Company Runner workspace or restrict all but one domain.",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        ...
        description:
          "Secure your Company Runner workspace with device-\ndependent two-factor authentication and passkeys. ",
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        title: "LDAP",
        description:
          "Get our official LDAP implementation and secure\nyour Company Runner workspace with your LDAP server.",
        comingSoon: true,
        cloud: {
          free: false,
          one: false,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: "Manage your self-hosted Company Runner instance better with\nan instance admin interface.",
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description:
          "Install and deploy your self-hosted Company Runner to any\nprivate cloud with a single-line command.",
        cloud: {
          free: false,
          one: true,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: (
          <>
            Get business-friendly SLAs with higher plans. SLAs are by priority of work item and tiers are available on
            request.
          </>
        ),
        cloud: {
