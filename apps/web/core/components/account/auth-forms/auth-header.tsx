...
const Titles = {
  [EAuthModes.SIGN_IN]: {
    [EAuthSteps.EMAIL]: {
      ...
      subHeader: "Welcome back to Company Runner.",
    },
    [EAuthSteps.PASSWORD]: {
      header: "Work in all dimensions.",
      subHeader: "Welcome back to Company Runner.",
  ...
  [EAuthModes.SIGN_UP]: {
    [EAuthSteps.EMAIL]: {
      header: "Work in all dimensions.",
      subHeader: "Create your Company Runner account.",
    },
    [EAuthSteps.PASSWORD]: {
      header: "Work in all dimensions.",
      subHeader: "Create your Company Runner account.",
...
export const AuthHeader = observer(function AuthHeader(props: TAuthHeader) {
  ...
  const getHeaderSubHeader = (
    step: EAuthSteps,
    mode: EAuthModes,
    fetchedInvitation: IWorkspaceMemberInvitation | undefined,
    email: string | undefined
  ) => {
    if (fetchedInvitation && email && fetchedInvitation.email === email && fetchedInvitation.workspace) {
      const workspace = fetchedInvitation.workspace;
      return {
        header: (
