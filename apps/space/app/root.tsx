...
const APP_TITLE = "Company Runner Publish | Make your boards public with one-click";
const APP_DESCRIPTION = "Company Runner Publish is a customer feedback management tool built on top of plane.so";
