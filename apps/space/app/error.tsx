      ...
      <div className="space-y-8 text-center">
        <div className="space-y-2">
          ...
          <p className="mx-auto text-13 text-secondary md:w-1/2">
            That crashed Company Runner, pun intended. No worries, though. Our engineers have been notified. If it
            persists, refresh the page or contact your workspace administrator.
          </p>
        </div>
