...
// assets
import InstanceFailureDarkImage from "@/app/assets/instance/instance-failure-dark.webp?url";
import InstanceFailureImage from "@/app/assets/instance/instance-failure.webp?url";
    ...
    <div className="relative container mx-auto flex h-screen items-center justify-center overflow-x-hidden overflow-y-auto px-5">
      <div className="relative w-auto max-w-2xl space-y-8 py-10">
        <div className="relative flex flex-col items-center justify-center space-y-4">
          <img src={instanceImage} width={210} height={206} alt="Company Runner instance failure" />
