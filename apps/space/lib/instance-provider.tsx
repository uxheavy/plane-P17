...
// assets
import PlaneBackgroundPatternDark from "@/app/assets/auth/background-pattern-dark.webp?url";
import PlaneBackgroundPattern from "@/app/assets/auth/background-pattern.webp?url";
// components
        ...
        <div className="flex h-screen w-full flex-col overflow-hidden overflow-y-auto">
          <div className="z-50 container mx-auto flex h-[110px] flex-shrink-0 items-center justify-between gap-5 px-5 lg:px-0">
            <div className="flex items-center gap-x-2 py-10">
              <Link to={`${SPACE_BASE_PATH}/`}>
                <CompanyRunnerLockup className="h-7 w-auto text-primary" />
              </Link>
            </div>
          </div>
          <div className="absolute inset-0 z-0">
            <img
              ...
              alt="Company Runner background pattern"
            />
          </div>
