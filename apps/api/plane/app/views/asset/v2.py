...
class AssetRestoreEndpoint(BaseAPIView):
    ...
    def post(self, request, slug, asset_id):
        asset = FileAsset.all_objects.exclude(
            entity_type__in=[FileAsset.EntityTypeContext.WORK_MAP_SCENE, FileAsset.EntityTypeContext.MESSAGE_ATTACHMENT]
        ).get(
...
class ProjectAssetEndpoint(BaseAPIView):
    ...
    def patch(self, request, slug, project_id, pk):
        # get the asset id
        asset = FileAsset.objects.exclude(
            entity_type__in=[FileAsset.EntityTypeContext.WORK_MAP_SCENE, FileAsset.EntityTypeContext.MESSAGE_ATTACHMENT]
        ).get(
